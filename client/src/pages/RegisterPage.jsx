  ...
  setGender('')
    ...
    return(
       ...
       <section className='fullpage'>
        ...
        <h1>Register</h1>
        <div className='wrap'>
        <input onChange={inputPhoto} className='photo' type='file'/><img id='profilePhoto' src={srcImg} style={{display:"inline"}}/><br/>
        </div>
<div className='allInform'>
        <label>Name* :</label>
<input onChange={inputName} value={name} type='text'className='input'/><br/>
 <label>Last Name* :</label>
<input onChange={inputLastName} value={lastName} type='text'className='input'/><br/>
...
<label>Date Of Birth* : 
 <input onChange={inputBirthDate} value="1997-07-07" type='date' className='input'/> </label><br/>



<label>Weight* : 
 <input onChange={inputWeight} value={weight} type='number'className='input'/> kg</label><br/>
<label> Height* :
<input onChange={inputHeight} value={height} type='number'className='input'/> cm</label><br/>
<label>Email* :</label>
